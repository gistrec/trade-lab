...
// The health apps (trade-lab-health*) live only in
// ops/ecosystem.health.config.js — never duplicate a pm2 app name here:
// whichever config reloads last silently wins the env.
module.exports = {
  apps: [
    {
