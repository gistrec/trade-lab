...
def test_day_buckets_use_utc_not_the_written_offset():
    ...
    midnight that splits one UTC day in two — and the interval label
    built from these keys would then be wrong."""
    from trade_lab.monitoring.app import _ladder_prev_day_delta
        ...
        def cycles(self, n=20):
            return [
                {"signal": {"asof": "2026-08-24T12:00:00+00:00",
                            "ladder_value": 0.0}},
                # 2026-08-26 00:00 +03:00 IS 2026-08-25 21:00 UTC.
                {"signal": {"asof": "2026-08-26T00:00:00+03:00",
                            "ladder_value": 1.0}},
            ]

    _delta, gap = _ladder_prev_day_delta(_R())
