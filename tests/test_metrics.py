...
def _verdict_metrics(
    ...
    return Metrics(
        ...
        num_trades=0, num_open_trades=0, win_rate=0.0,
        avg_trade_return=0.0, avg_gross_trade_return=0.0,
        avg_net_trade_return=0.0, avg_cost_per_trade=0.0,
        avg_win=0.0, avg_loss=0.0,
        best_trade_return=0.0, worst_trade_return=0.0,
        avg_holding_period=0.0, median_holding_period=0.0,
        exposure_pct=0.0, fees_pct_of_initial_cash=0.0,
